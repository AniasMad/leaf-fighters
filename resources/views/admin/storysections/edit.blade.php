...
<!-- Create Post Form -->
<div class="px-6 py-3">
    <h4 class="text-2xl font-bold dark:text-white">{{ __('Edit Story Section') }}</h4>
</div>
<div class="px-6 py-3">
<form enctype="multipart/form-data" action="{{ route('admin.storysections.update', $storysection->id) }}" method="post">
